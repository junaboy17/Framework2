...
public class TC_BHOPS_11224_Org_Add_Identifier_Duplicate_Error_Message extends OrganizationPage{


	@Test(priority=1)
	public void Add_Identifier_Duplicate_Error_Message() {
		...
		try{
			...
			Expected ="ERROR Message:\n"
					...
					+ "Organization =" + OrgDHHS + ", Location ID=" + ID + ", EMPLOYER IDENTIFICATION NUMBER ID=" + RandNum8 + ", Start Date=" + Today + ", End Date=null";

...
public class TC_People_Identifiers_Add_Edit_View extends OrganizationPage{

	@Test(priority=1)
	public void TC_People_Identifiers_Add_001() {
	...
	@Test(priority=2)
	public void TC_People_Identifiers_Edit_001() {
		SoftAssert = new SoftAssert();
	...
	@Test(priority=3)
	public void TC_People_Identifiers_View_001() {
		SoftAssert = new SoftAssert();
